...
export default function Outcomes() {
  ...
  return (
    <section id="outcomes" className="pt-16 md:pt-24 bg-[#e5e5e5]">
      {/* Top-Arc Dome Section Opener */}
      <div className="card-top-arc bg-[#ffffff] section-saas">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              {outcomes.map((item, index) => (
                <div
                  key={index}
                  className="p-8 rounded-[24px] bg-[#f3f3f3] flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6"
                >
                  <div className="p-3 rounded-[12px] bg-[#ffffff] shrink-0">
                    {item.icon}
                  </div>
                  <div className="space-y-2 flex-grow">
                    ...
                    <p className="text-[15px] text-[#444444] leading-[1.6]">
                      {item.desc}
                    </p>
                  </div>
                </div>
            ...
            <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-28">
              <div className="card-inverted p-8 md:p-10 space-y-6">
                ...
                <div className="space-y-3">
                  <h3 className="font-condensed-display text-[32px] font-bold text-white leading-none">
                    LEARN BY BUILDING, NOT WATCHING.
                  </h3>
                  <p className="text-[15px] text-[#979797] leading-[1.6]">
                ...
                <div className="bg-[#1f1f29] rounded-[16px] p-5 font-mono text-[13px] leading-relaxed text-[#d1ffca] space-y-1.5 border border-[#2f2f2f]">
