# Kids Lab Workshop Landing Page (AI & Robotics)

This repository contains the Kids Lab internship assessment project. It features a modern, responsive landing page built with React + TypeScript + Tailwind CSS (v4) and an Express.js API backend integrated with MongoDB.
